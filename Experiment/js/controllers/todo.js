...
(function () {
    ...
    app.controller = function() {
        ...
        this.list = new app.TodoList(); // Todos collection
        ...
        //check whether a todos is visible
        this.isVisible = function() { //predtym function(todo)
            if(this.filter() == '')
                return true;
        ...
        // Removing a Todos from the list
